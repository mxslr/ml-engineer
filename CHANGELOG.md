...
- Per-problem metric selection and per-problem explainability, so metrics and interpretation tools fit the task.
- Notebook delivery for Kaggle, Google Colab, or a local GPU run.
- Works in Claude Code and Antigravity. Codex, Cursor, and more planned.
